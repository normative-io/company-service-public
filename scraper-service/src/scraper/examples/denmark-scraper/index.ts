...
import { CheckResult, FetchResult, FoundCompany, IScraper } from 'src/dto/scraper.interface';
...
export class DenmarkScraper implements IScraper {
   ...
   */
  private async toCompanies(request: FetchByCompanyIdDto, response: VirkResponse): Promise<FoundCompany[]> {
